...
<head>
    ...
    <title>Gerenciar Precrições Psicológicas</title>
...
<div class="header">
    <h2>Gerenciar Precrições Psicológicas</h2>
</div>

<div class="container mt-4 flex-grow-1">
    <div class="new-record text-left">
        <a href="/prescricao/create" class="btn btn-primary">
            Novo Registro
        </a>
    ...
    <table class="table table-hover">
        ...
        <tbody>
            @foreach($prescricao as $a)
                <tr>
                    <td>{{ \Carbon\Carbon::parse($a->data_prescricao)->format('d/m/Y') }}</td>
                    <td>{{ $a->paciente->nome }}</td>
                    <td>
                        <a href="/prescricao/{{ $a->id }}" class="btn btn-secondary">
                            Ver Registro
                        </a>
                        <a href="/prescricao/{{ $a->id }}/edit" class="btn btn-warning">
                            Alterar Registro
                        </a>
                    </td>
                </tr>
