...
<head>
    ...
    <title>Cadastro de Prescrição Psicológica</title>
...
<div class="header">
    <h2>Cadastro de Prescrição Psicológica</h2>
</div>
    ...
    <form method="POST" action="/prescricao">
        ...
        <div class="form-group">
            ...
            <input type="date" id="data_prescricao" 
                name="data_prescricao" class="form-control" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="descricao_prescricao">Descrição Prescrição</label>
            <textarea id="descricao_prescricao" name="descricao_prescricao" class="form-control" rows="2" required></textarea>
        </div>
