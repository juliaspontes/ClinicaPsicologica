...
<head>
    ...
    <title>Cadastro de Agendamento Psicológico</title>
...
<div class="header">
    <h2>Cadastro de Agendamento Psicológico</h2>
</div>
    ...
    <form method="POST" action="/agendamento">
        ...
        <div class="form-group">
            ...
            <input type="date" id="data_agendamento" 
                name="data_agendamento" class="form-control" required>
        </div>
        <div class="form-group">
        ...
        <input type="time" id="hora_agendamento" 
            name="hora_agendamento" class="form-control" required>
        </div>
