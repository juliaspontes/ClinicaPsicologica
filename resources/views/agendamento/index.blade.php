...
<head>
    ...
    <title>Gerenciar Agendamento Psicológico</title>
...
<div class="header">
    <h2>Gerenciar Agendamento Psicológico</h2>
</div>
    ...
    <table class="table table-hover">
        ...
        <tbody>
            @foreach($agendamento as $a)
                <tr>
                    <td>{{ \Carbon\Carbon::parse($a->data_agendamento)->format('d/m/Y') }}</td>
                    <td>{{ $a->paciente->nome }}</td>
                    <td>
                        <a href="/agendamento/{{ $a->id }}" class="btn btn-secondary">
                            Ver Registro
                        </a>
                        <a href="/agendamento/{{ $a->id }}/edit" class="btn btn-warning">
                            Alterar Registro
                        </a>
                    </td>
                </tr>
