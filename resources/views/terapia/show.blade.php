...
<head>
    ...
    <title>Registro de Terapia Psicológica</title>
...
<div class="container flex-grow-1">
    <div class="form-group">
        <label class="label" for="data_sessao">Data:</label>
    ...
    <div class="form-group">
        <label class="label" for="tecnicasutilizadas">Técnicas Utilizadas:</label>
        <p>{{$terapia->tecnicasutilizadas}}</p>
    </div>
</div>
