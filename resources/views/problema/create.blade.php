...
<head>
    ...
    <title>Cadastro de Condição Psicológica</title>
...
<div class="header">
    <h2>Cadastro de Condição Psicológica</h2>
</div>
...
<div class="container flex-grow-1">
    <form method="POST" action="/problema">
        ...
        <div class="form-group">
            ...
            <textarea id="evolucao" name="evolucao" class="form-control" rows="2" required></textarea>
        </div>
