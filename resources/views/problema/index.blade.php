...
<head>
    ...
    <title>Gerenciar Condições Psicológicas</title>
...
<div class="header">
    <h2>Gerenciar Condições Psicológicas</h2>
</div>

<div class="container mt-4 flex-grow-1">
    <div class="new-record text-left">
        <a href="/problema/create" class="btn btn-primary">
            Novo Registro
        </a>
    ...
    <table class="table table-hover">
        ...
        <tbody>
            @foreach($problema as $a)
                <tr>
                    <td>{{ \Carbon\Carbon::parse($a->data_identificacao)->format('d/m/Y') }}</td>
                    <td>{{ $a->paciente->nome }}</td>
                    <td>
                        <a href="/problema/{{ $a->id }}" class="btn btn-secondary">
                            Ver Registro
                        </a>
                        <a href="/problema/{{ $a->id }}/edit" class="btn btn-warning">
                            Alterar Registro
                        </a>
                    </td>
                </tr>
