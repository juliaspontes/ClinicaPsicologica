...
<head>
    ...
    <title>Cadastro de Encaminhamento Psicológico</title>
...
<div class="header">
    <h2>Cadastro de Encaminhamento Psicológico</h2>
</div>
    ...
    <form method="POST" action="/encaminhamento">
        ...
        <div class="form-group">
            ...
            <input type="date" id="data_encaminhamento" 
                name="data_encaminhamento" class="form-control" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea id="profissional_encaminhado" name="profissional_encaminhado" class="form-control" rows="3" required></textarea>
        </div>
        <div class="form-group">
            <label for="descricao_encaminhamento">Descrição do Encaminhamento</label>
            <textarea id="descricao_encaminhamento" name="descricao_encaminhamento" class="form-control" rows="2" required></textarea>
        </div>
