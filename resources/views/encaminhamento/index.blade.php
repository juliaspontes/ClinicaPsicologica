...
<head>
    ...
    <title>Gerenciar Encaminhamento Psicológico</title>
...
<div class="header">
    <h2>Gerenciar Encaminhamento Psicológico</h2>
</div>
    ...
    <table class="table table-hover">
        ...
        <tbody>
            @foreach($encaminhamento as $a)
                <tr>
                    <td>{{ \Carbon\Carbon::parse($a->data_encaminhamento)->format('d/m/Y') }}</td>
