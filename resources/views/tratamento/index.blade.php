...
<head>
    ...
    <title>Gerenciar Tratamentos Psicológicos</title>
...
<div class="header">
    <h2>Gerenciar Tratamentos Psicológicos</h2>
</div>

<div class="container mt-4 flex-grow-1">
    <div class="new-record text-left">
        <a href="/tratamento/create" class="btn btn-primary">
            Novo Registro
        </a>
    ...
    <table class="table table-hover">
        ...
        <tbody>
            @foreach($tratamento as $a)
                <tr>
                    <td>{{ \Carbon\Carbon::parse($a->data_inicio)->format('d/m/Y') }}</td>
                    <td>{{ $a->paciente->nome }}</td>
                    <td>
                        <a href="/tratamento/{{ $a->id }}" class="btn btn-secondary">
                            Ver Registro
                        </a>
                        <a href="/tratamento/{{ $a->id }}/edit" class="btn btn-warning">
                            Alterar Registro
                        </a>
                    </td>
                </tr>
