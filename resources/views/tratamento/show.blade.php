...
<head>
    ...
    <title>Registro de Tratamento Psicológico</title>
...
<div class="header">
    <h2>Registro de Tratamento Psicológico</h2>
</div>

<div class="container flex-grow-1">
    <div class="form-group">
        <label class="label" for="data_inicio">Data:</label>
        <p>{{ \Carbon\Carbon::parse($tratamento->data_inicio)->format('d/m/Y') }}</p>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="label" for="progresso">Progresso:</label>
