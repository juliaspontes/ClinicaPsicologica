...
<head>
    ...
    <title>Cadastro de Tratamento Psicológico</title>
...
<div class="header">
    <h2>Cadastro de Tratamento Psicológico</h2>
</div>
...
<div class="container flex-grow-1">
    <form method="POST" action="/tratamento">
        ...
        <div class="form-group">
            ...
            <textarea id="objetivos" name="objetivos" class="form-control" rows="3" required></textarea>
        </div>
        <div class="form-group">
