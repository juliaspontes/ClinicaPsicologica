...
<head>
    ...
    <title>Gerenciar Avaliações Psicológicas</title>
...
<div class="container mt-4 flex-grow-1">
    <div class="new-record text-left">
        <a href="/paciente/create" class="btn btn-primary">
            Novo Registro
        </a>
        ...
        <tbody>
            @foreach($pacientes as $a)
                <tr>
                    <td>{{ $a->nome }}</td>
                    <td>
                        <a href="/paciente/{{ $a->id }}" class="btn btn-secondary">
                            Ver Registro
                        </a>
                        <a href="/paciente/{{ $a->id }}/edit" class="btn btn-warning">
                            Alterar Registro
                        </a>
                    </td>
                </tr>
