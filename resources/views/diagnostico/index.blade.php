...
<head>
    ...
    <title>Gerenciar Diagnósticos Psicológicos</title>
...
<div class="header">
    <h2>Gerenciar Diagnósticos Psicológicos</h2>
</div>
...
<div class="container mt-4 flex-grow-1">
    ...
    <table class="table table-hover">
        ...
        <tbody>
            @foreach($diagnostico as $a)
                <tr>
                    <td>{{ \Carbon\Carbon::parse($a->data_diagnostico)->format('d/m/Y') }}</td>
                    <td>{{ $a->paciente->nome }}</td>
                    <td>
                        <a href="/diagnostico/{{ $a->id }}" class="btn btn-secondary">
                            Ver Registro
                        </a>
                        <a href="/diagnostico/{{ $a->id }}/edit" class="btn btn-warning">
                            Alterar Registro
                        </a>
                    </td>
                </tr>
