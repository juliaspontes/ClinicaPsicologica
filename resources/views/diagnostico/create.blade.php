...
<head>
    ...
    <title>Cadastro de Diagnóstico Psicológico</title>
...
<div class="header">
    <h2>Cadastro de Diagnóstico Psicológico</h2>
</div>
    ...
    <form method="POST" action="/diagnostico">
        ...
        <div class="form-group">
            ...
            <input type="date" id="data_diagnostico" 
                name="data_diagnostico" class="form-control" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea id="diagnostico" name="diagnostico" class="form-control" rows="3" required></textarea>
        </div>
        <div class="form-group">
